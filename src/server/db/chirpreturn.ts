...
const createchirp = async (userid:string, content:string, location:string) => Query('INSERT INTO chirps (userid, content) VALUES(userid = ?, content = ?, location=?)', [userid,content, location])
